...
import com.zhang.boot.bean.Car;
...
*/
@EnableConfigurationProperties(Car.class)//1.开启Car配置绑定功能  2.把这个Car组件自动注册到容器中
...
public class MyConfig {
    ...
    * */
    ...
    @Bean //给容器添加组件，以方法名作为组件id，返回类型就是组件类型，返回的值，就是组件在容器中的实例
    public User user01() {
